...
enyo.path.addPaths({layout: "C://Users/Ruud/Documents/GitHub/Learning/enyo/tools/../../lib/layout/", onyx: "C://Users/Ruud/Documents/GitHub/Learning/enyo/tools/../../lib/onyx/", onyx: "C://Users/Ruud/Documents/GitHub/Learning/enyo/tools/../../lib/onyx/source/"});
...
this.$.rowname.setContent("This is row " + b.index);
},
create: function() {
this.inherited(arguments);
for (var a = 0; a < this.panelArrangers.length; a++) this.$.arrangerPicker.createComponent({
content: this.panelArrangers[a].name
});
...
arrangerSelected: function(a, b) {
var c = this.$.samplePanels, d = this.panelArrangers[b.originator.indexInContainer()];
this.currentClass && c.removeClass(this.currentClass), d.classes && (c.addClass(d.classes), this.currentClass = d.classes), c.setArrangerKind(d.arrangerKind), enyo.Panels.isScreenNarrow() && this.setIndex(1);
},
prevPanel: function() {
...
panelCount: 0,
addPanel: function() {
var a = this.$.samplePanels, b = this.panelCount++, c = a.createComponent({
style: "background:" + this.bgcolors[b % this.bgcolors.length],
content: b
});
c.render(), a.reflow(), a.setIndex(b);
},
